...
bulletSound = pygame.mixer.Sound(os.path.join('Game','bullet.wav'))
hitSound = pygame.mixer.Sound(os.path.join('Game','hit.wav'))

music = pygame.mixer.music.load(os.path.join('Game','music.mp3'))
...
def main_loop():
	...
	while run:
		...
		# if the goblin is killed display "you win"
		else:

			if event.type == pygame.KEYDOWN and event.key == pygame.K_r:
				main_loop()
			font1 = pygame.font.SysFont('comicsans', 30)
			text = font1.render("YOU WIN! PRESS 'R' TO START A NEW GAME!", 1, (0, 255, 0))
			win.blit(text, (30, 240))
			pygame.display.update()
...
if __name__ == '__main__':
	...
	if not main_loop.goblin.visible == True:
